...
curl http://10.110.1.254/deployment/scripts/SLAVE01-base.bash | /bin/bash -x | tee /tmp/mainscript-default-output
curl http://10.110.1.254/deployment/scripts/SLAVE99-nfs.bash | /bin/bash -x | tee /tmp/mainscript-default-output
